#pragma once
// =====================================================================
//  Persistent settings, calendar maths and the DST rule.
//
//  Nothing in this file touches hardware, so the rules the milestone
//  spells out (leap years, month lengths, the US DST changeover) live
//  somewhere you can read and check on their own.
// =====================================================================
#include <stdint.h>
#include <RTClib.h>

// ---- one alarm --------------------------------------------------------
// Milestone 03 sections 9-13. Times are stored as 24-hour internally and
...
// out, so a DST change never rewrites the chip - Milestone 03 section 14.
