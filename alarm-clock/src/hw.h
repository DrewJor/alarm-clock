...
// Hardware services used by the UI; pin access is implemented in main.cpp.
#include <stdint.h>
#include <RTClib.h>
#include <U8g2lib.h>
...
// clock
// Timekeeping is the sole RTC writer. The value passed in and
